...
export const Col = styled.div`
  ...
  margin-right: ${props => props.pull || 0}px;
  ...
  @media only screen and (min-width: 960px) {
    ...
    margin-left: ${props => props.offset_lg || props.offset_md || 0}px;
    margin-right: ${props => props.pull_lg || props.pull_md || 0}px;
  }

  @media only screen and (min-width: 1280px) {
    flex-basis: ${props => 100 / 12 * (props.xl || props.sm || 0)}%;
    margin-left: ${props => props.offset_xl || props.offset_lg || 0}px;
    margin-right: ${props => props.pull_xl || props.pull_lg || 0}px;
  }
`
