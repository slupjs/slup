...
export const Col = styled.div`
  ...
  display: ${props => props.hide_sm ? 'none' : 'initial'};
  ...
  @media only screen and (min-width: 480px) {
    ...
    display: ${props => (props.hide_md || props.hide_sm) ? 'none' : 'initial'};
  }
  ...
  @media only screen and (min-width: 960px) {
    ...
    display: ${props => (props.hide_lg || props.hide_md || props.hide_sm) ? 'none' : 'initial'};
  }
  ...
  @media only screen and (min-width: 1280px) {
    ...
    display: ${props => (props.hide_xl || props.hide_lg || props.hide_md || props.hide_sm) ? 'none' : 'initial'};
  }
`
